        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-blue-100">Fill in the information below to start a parking session</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.sessions.store') }}" method="POST" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    <label for="plate_number" class="block text-sm font-semibold text-slate-700 mb-2">
                        <i class="ri-car-line mr-2 text-blue-600"></i>
                        Plate Number <span class="text-red-500">*</span>
                    </label>
                    <select id="plate_number" name="plate_number" class="select2 w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @error('plate_number') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    <select id="parking_rate_id" name="parking_rate_id" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @error('parking_rate_id') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    <input id="start_time" name="start_time" type="datetime-local"
                           class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @error('start_time') border-red-500 @enderror"
            ...
            <div id="session-preview" class="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200 hidden">
                <h3 class="text-lg font-semibold text-slate-800 mb-4 flex items-center">
                    <i class="ri-eye-line mr-2 text-blue-600"></i>
                    Session Preview
                </h3>
            ...
            <div class="flex items-center justify-between mt-8 pt-6 border-t border-slate-200">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button type="submit" class="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl transition-all duration-200 font-semibold shadow-lg hover:shadow-xl flex items-center">
